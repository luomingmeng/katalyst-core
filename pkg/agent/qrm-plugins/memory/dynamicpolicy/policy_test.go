...
func TestAllocate(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			description: "req for reclaim_cores with actual numa_binding main container",
			req: &pluginapi.ResourceRequest{
				PodUid:         string(uuid.NewUUID()),
				PodNamespace:   testName,
				PodName:        testName,
		...
		{
			description: "req for reclaim_cores with non-actual numa_binding main container",
			req: &pluginapi.ResourceRequest{
				PodUid:         string(uuid.NewUUID()),
				PodNamespace:   testName,
				PodName:        testName,
