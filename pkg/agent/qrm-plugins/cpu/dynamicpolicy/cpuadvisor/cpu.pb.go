...
type ListAndWatchResponse struct {
	...
	FillDefaultSharePoolWithNonReclaimCpus     bool                           `protobuf:"varint,5,opt,name=fill_default_share_pool_with_non_reclaim_cpus,json=fillDefaultSharePoolWithNonReclaimCpus,proto3" json:"fill_default_share_pool_with_non_reclaim_cpus,omitempty"`
...
func (m *ListAndWatchResponse) GetFillDefaultSharePoolWithNonReclaimCpus() bool {
	if m != nil {
		return m.FillDefaultSharePoolWithNonReclaimCpus
	}
	return false
}
...
type GetAdviceResponse struct {
	...
	FillDefaultSharePoolWithNonReclaimCpus     bool                               `protobuf:"varint,6,opt,name=fill_default_share_pool_with_non_reclaim_cpus,json=fillDefaultSharePoolWithNonReclaimCpus,proto3" json:"fill_default_share_pool_with_non_reclaim_cpus,omitempty"`
	XXX_NoUnkeyedLiteral                       struct{}                           `json:"-"`
	XXX_sizecache                              int32                              `json:"-"`
}
...
func (m *GetAdviceResponse) GetFillDefaultSharePoolWithNonReclaimCpus() bool {
	if m != nil {
		return m.FillDefaultSharePoolWithNonReclaimCpus
	}
	return false
...
var fileDescriptor_08fc9a87e8768c24 = []byte{
	...
	,
}
...
func (m *ListAndWatchResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FillDefaultSharePoolWithNonReclaimCpus {
		i--
		if m.FillDefaultSharePoolWithNonReclaimCpus {
			dAtA[i] = 1
		} else {
...
func (this *ListAndWatchResponse) String() string {
	...
	s := strings.Join([]string{`&ListAndWatchResponse{`,
		...
		`FillDefaultSharePoolWithNonReclaimCpus:` + fmt.Sprintf("%v", this.FillDefaultSharePoolWithNonReclaimCpus) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ListAndWatchResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FillDefaultSharePoolWithNonReclaimCpus", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FillDefaultSharePoolWithNonReclaimCpus = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipCpu(dAtA[iNdEx:])
			if err != nil {
