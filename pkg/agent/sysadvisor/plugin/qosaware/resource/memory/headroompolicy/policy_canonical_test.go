	...
	tests := []struct {
		...
		},
		{
			...
			fields: fields{
				...
				policyCanonicalConfiguration: &headroom.MemoryPolicyCanonicalConfiguration{
					EnableBuffer:                    true,
					MemoryFreeEstimationUtilization: 0.6,
					StaticMemoryOversold:            20 << 30,
				},
				essentials: types.ResourceEssentials{
					EnableReclaim:       true,
					Total:               100 << 30,
		...
		},
		{
			...
			fields: fields{
				...
				policyCanonicalConfiguration: &headroom.MemoryPolicyCanonicalConfiguration{
					EnableBuffer:                          true,
					CacheOversoldRate:                     0.6,
					CacheOversoldMemoryCPURatioUpperBound: 6,
					CacheOversoldMemoryCPURatioLowerBound: 3.5,
					MemoryFreeEstimationUtilization:       0.6,
					StaticMemoryOversold:                  20 << 30,
				},
				essentials: types.ResourceEssentials{
