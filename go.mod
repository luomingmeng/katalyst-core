...
require (
	...
	github.com/kubewharf/katalyst-api v0.5.7-0.20250917055908-9bd852e706b6
...
replace (
	github.com/kubewharf/katalyst-api => github.com/luomingmeng/katalyst-api v0.0.0-20250929094150-8a55c64d65fa
